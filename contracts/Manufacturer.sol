...
contract Manufacturer {
    ...
    // Creating Pills
    function createPills(uint _productionSequence, string memory _sku, uint256 _timestamp) public onlyManufacturer {
        ...
        productionSequence++;
        emit PillCreated("Pill created, number:", _productionSequence, _sku, _secret);
    }
